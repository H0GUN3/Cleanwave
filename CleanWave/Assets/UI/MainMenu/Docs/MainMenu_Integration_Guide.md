...
| 오브젝트 | 설명 |
|----------|------|
| `Background` | `mainmenu_background_final.png` 전체 시안 (1024×576, Raycast Target **OFF**) |
| `GameStartButton` | 초록 **시작** 버튼 위 투명 클릭 영역 (Raycast **ON**) |
| `ExitButton` | 파란 **종료** 버튼 위 투명 클릭 영역 (Raycast **ON**) |
