namespace CleanWave.Core
{
    ...
    {
        public const int ZoneWidthTiles = 20;
        public const int ZoneHeightTiles = 15;
        public const int PurificationPercentToUnlockNextZone = 100;

        public const int CityTrashCount = 20;
        public const int RiverTrashCount = 25;
        public const int CoastTrashCount = 30;

        public const int WrongSortScorePenalty = -5;
