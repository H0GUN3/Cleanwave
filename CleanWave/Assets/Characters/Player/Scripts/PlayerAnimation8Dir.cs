...
{
    const int MinimumPlayerSortingOrder = 30;
    ...
    void Awake()
    {
        ...
        if (spriteRenderer != null && spriteRenderer.sortingOrder < MinimumPlayerSortingOrder)
            spriteRenderer.sortingOrder = MinimumPlayerSortingOrder;
    }
